                                        ...
                                        <div className="h-full w-[92%] flex flex-col items-center justify-center overflow-visible pt-[2%] pb-[2%]">
                                            {activeMainTab === 'help' && helpPhase === 'both' ? (
                                                ...
                                                <>
                                                    ...
                                                    <div className={`group relative z-[30] pointer-events-auto flex flex-col items-center justify-center w-full max-w-5xl -mt-[16rem] sm:-mt-[18rem] ml-[32rem] sm:ml-[36rem] transition-transform duration-200 origin-center hover:scale-[1.01] cursor-pointer ${profileClosing ? 'animate-bounce-out' : 'animate-bounce-in'}`}>
